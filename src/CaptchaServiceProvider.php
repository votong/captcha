...
class CaptchaServiceProvider extends ServiceProvider {
	...
	public function boot() {
		...
		// HTTP routing
		$this->app['router']->get('captcha/{config?}/{formId?}', '\VoTong\Captcha\CaptchaController@getCaptcha');
		$this->app['router']->post('check-captcha', '\VoTong\Captcha\CaptchaController@postCheckCaptcha');
